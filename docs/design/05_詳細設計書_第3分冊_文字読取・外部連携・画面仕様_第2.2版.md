...
<img alt="画面イメージ" src="画像/05_詳細設計書_第3分冊/画面1_ログイン画面.png">

### 13.2 出荷予定一覧画面

<img alt="画面イメージ" src="画像/05_詳細設計書_第3分冊/画面2_出荷予定一覧画面.png">
...
<img alt="画面イメージ" src="画像/05_詳細設計書_第3分冊/画面3_出荷予定詳細・出荷実績一覧画面.png">
...
<img alt="画面イメージ" src="画像/05_詳細設計書_第3分冊/画面4_出荷実績詳細画面.png">
...
<img alt="画面イメージ" src="画像/05_詳細設計書_第3分冊/画面5_写真登録メニュー.png">
...
<img alt="画面イメージ" src="画像/05_詳細設計書_第3分冊/画面6_文字読取用黒板写真確認画面.png">
...
<img alt="画面イメージ" src="画像/05_詳細設計書_第3分冊/画面7_写真一覧画面.png">
...
<img alt="画面イメージ" src="画像/05_詳細設計書_第3分冊/画面8_保存完了画面.png">
...
<img alt="TP採取結果入力画面イメージ" src="画像/05_詳細設計書_第3分冊/画面9_試験体採取結果入力画面.png">
...
<img alt="OCR結果確認画面イメージ" src="画像/05_詳細設計書_第3分冊/画面10_文字読取結果確認画面.png">
